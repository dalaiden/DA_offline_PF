...
for i_var in range(len(list_variables)):
	...
	for i_season in range(len(list_seasons)):
		...
		for i_region in range(len(list_regions)):
			...
			list_files = glob('{}/{}/*_{}_{}.nc'.format(pid_s, var_ID, season_id,region_id))
			list_files.sort()
			...
			# Export the file
			outfile_name = '{}/{}/{}_DA-{}_{}-{}_{}_{}.nc'.format(outfolder, exp_id, var_ID, model_ID, year_a, year_b, season_id, region_id)
			# print('		--> '+outfile_name)
