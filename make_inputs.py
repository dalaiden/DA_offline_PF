...
list_seasons = ["ANN"]
ocean_mask = False
loc_data = '/home/elic/hgs/20th_reconstruction_hgs_fogt/composites/netcdfs'
loc_data_prior = '/cyfast/dalaiden/20th_reconstruction_hgs_fogt/upscaling/files'
grid_size = '500km'
